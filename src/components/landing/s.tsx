            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <ScrollReveal delay={0.1}>
                    <motion.a
                        ...
                        className="group relative block p-8 md:p-10 rounded-3xl border border-border/80 bg-background hover:border-sohub-orange/25 shadow-[0_1px_3px_0_hsl(0,0%,0%,0.04)] hover:shadow-[0_20px_50px_-12px_hsl(0,0%,0%,0.08)] transition-all duration-300 overflow-hidden"
                    >
                        {/* Subtle corner gradient */}
                        <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-sohub-orange/[0.04] to-transparent rounded-bl-[100px] pointer-events-none" />

                        <div className="relative">
                            {/* SVG Illustration */}
                            <div className="mb-10 flex justify-center">
                                <div className="w-full max-w-[240px] aspect-[5/3] rounded-2xl border border-border/60 bg-secondary/30 flex items-center justify-center p-4">
                                    <EdgeEngineSVG />
                                </div>
                            </div>
...
/* Clean SVG illustration for Edge Engine */
const EdgeEngineSVG = () => (
    <motion.svg
        width="200"
        height="120"
    ...
    >
        ...
        {[[20, 40], [20, 90], [180, 40], [180, 90]].map(([x, y], i) => (
            <g key={i}>
                <motion.line
                    x1={x} y1={y} x2={x < 100 ? 60 : 140} y2={y < 70 ? 50 : 80}
